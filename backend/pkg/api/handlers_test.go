...
func TestStoreSensorReading(t *testing.T) {
	...
	request := StoreSensorReadingRequest{
		...
		SensorType: device.SensorTypeTemperature,
...
func TestGetSensorReadings(t *testing.T) {
	...
	store.StoreSensorReading(ctx, "test-dev-001", "test-sensor-001", "Temperature Sensor", device.SensorTypeTemperature, reading)
...
func TestStoreActuatorState(t *testing.T) {
	...
	request := StoreActuatorStateRequest{
		...
		ActuatorType: device.ActuatorTypeRelay,
